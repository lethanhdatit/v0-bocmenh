...
export const metadata: Metadata = createSEOMetadata({
  ...
  description: "📜 Điều khoản và điều kiện sử dụng dịch vụ Bóc Mệnh. Quy định pháp lý, quyền và nghĩa vụ của người dùng khi sử dụng các dịch vụ huyền học, phong thủy online.",
