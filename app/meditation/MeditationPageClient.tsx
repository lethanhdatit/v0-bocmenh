      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-4">
            Thiền Định Cá Nhân Hóa
          </h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-700 mb-6">Meditation Guides</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Khám phá sức mạnh biến đổi của thiền định với hướng dẫn AI cá nhân hóa. Tìm thấy sự bình an nội tâm, giảm
            căng thẳng và nâng cao sức khỏe thông qua thực hành chánh niệm phù hợp với bạn.
          </p>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mt-2">
            Discover the transformative power of meditation with personalized AI guidance. Find inner peace, reduce
            stress, and enhance your well-being through mindful practice tailored to you.
          </p>
        </div>
            ...
            <Card className="bg-gradient-to-r from-purple-100 to-indigo-100 border-purple-200">
              <CardHeader>
                <CardTitle className="text-xl font-bold text-gray-800">
                  {language === "vi" ? "Mẹo Bắt Đầu Thiền" : "Getting Started Tips"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-purple-500 mt-1">•</span>
                        {language === "vi" ? "Đừng phán xét những suy nghĩ xuất hiện" : "Don't judge thoughts that arise"}
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-purple-500 mt-1">•</span>
                        {language === "vi" ? "Tham gia cộng đồng thiền định" : "Join meditation communities"}
                      </li>
                    </ul>
                  </div>
                </div>
