...
async function getFilterOptionsHandler(
  _data: any,
  request: NextRequest,
  ...
  try {
    ...
    const response = await apiServer.get("/affiliate/filter-options", {
      ...config,
    });
    ...
    return handleApiServerError(
      error,
      {
        error400Message: t("common.products.getFilterOptionsFailed", "Không thể tải tùy chọn lọc sản phẩm"),
...
export const GET = withServerBase(getFilterOptionsHandler, {
