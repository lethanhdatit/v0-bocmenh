...
export default function WishlistClient() {
  ...
  const fetchFavorites = useCallback(
    async (
      ...
      try {
        ...
        setError(
          t("wishlist.errorLoading", "Không thể tải danh sách yêu thích")
        );
      } finally {
        setIsLoading(false);
  ...
  const handleProductUnfavorited = useCallback(
    (productId: string) => {
        ...
        <div className="container mx-auto py-8 min-h-[calc(100vh-200px)] flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-300 text-sm sm:text-base">
              {t("wishlist.loading", "Đang tải danh sách yêu thích...")}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto py-16 min-h-[calc(100vh-200px)] flex flex-col items-center justify-center text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold text-white mb-3">
            {t("wishlist.errorTitle", "Có lỗi xảy ra")}
          </h1>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto py-16 min-h-[calc(100vh-200px)] flex flex-col items-center justify-center text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold text-white mb-3">
            {t("wishlist.emptyTitle", "Danh sách yêu thích trống")}
          </h1>
          <p className="text-gray-400 mb-8 max-w-md text-sm sm:text-base">
            {t(
              "wishlist.emptySubtitle",
              "Hãy thêm những sản phẩm yêu thích để dễ dàng tìm lại sau này"
            )}
          </p>
          <Button
            asChild
            className="bg-yellow-500 hover:bg-yellow-400 text-black font-semibold shadow-lg hover:shadow-yellow-500/30"
          >
            <Link href="/store">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-xs sm:text-sm text-gray-400">
                  {t("wishlist.totalFavorites", "Tổng sản phẩm yêu thích")}
                </div>
              </div>
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className="h-8 w-8 p-0 bg-gray-700/50 text-gray-300 transition-all flex-shrink-0"
              >
                <RefreshCw
                ...
                {isLoadingMore ? (
                  <div className="flex items-center space-x-2 text-yellow-500">
                    ...
                    <span className="text-sm sm:text-base">
                      {t("wishlist.loadingMore", "Đang tải thêm...")}
                    </span>
                  </div>
                ) : (
                  <div className="text-center">
                    <div className="text-gray-400 text-sm mb-2">
                      {t("wishlist.scrollForMore", "Cuộn xuống để xem thêm")}
                    </div>
              ...
              <div className="text-center py-6 sm:py-8">
                <div className="inline-flex items-center space-x-2 text-gray-500 bg-gray-800/30 px-4 py-2 rounded-lg border border-gray-700">
                  ...
                  <span className="text-sm">
                    {t(
                      "wishlist.endOfResults",
                      "Đã hiển thị tất cả sản phẩm yêu thích"
                    )}
                  </span>
                </div>
              </div>
